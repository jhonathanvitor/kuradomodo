...
@section('title', $projetos->title)

{{-- Define o título da página como o título do projeto --}}
    ...
    <div class="container mx-auto px-4 py-8 pt-24">
        ...
        <article class="max-w-3xl mx-auto bg-white p-6 md:p-10 rounded-lg shadow-lg">
            ...
            <p class="text-gray-600 text-sm mb-6">
                Publicado em: {{ \Carbon\Carbon::parse($projetos->date)->format('d/m/Y') }}
            </p>
